{
  ...
  "16": {
    ...
    "responses": [
      {
        "text": "As you know I am still in early stage and my team wants to fully understand the problem I'm solving. 🐥\n\nTherefore I want to invite you to a quick *discovery process* to learn how can I help you best. \n\nPlease *join the conversation* here: 🚀\n\n{html}<div class='hu-btn hu-btn-sm hu-btn-pink' style=\"display: inline-block;\" onclick='javascript:window.parent.loadHelloumiLiveChat(\"discorbot\",\"@email\");window.parent.trackEvent(\"flag20\",\"Landbot Chat\", \"Goes to Discorbot\");'>Click here</div>{/html}",
        "order": 0,
        "entity": "text"
      }
    ],
  ...
  "76": {
    ...
    "responses": [
      {
        "text": "If you want anything else, write it here and I will send it to our support team as soon as possible 😉",
        "order": 0,
        "entity": "text"
      }
    ],
  ...
  "78": {
    ...
    "responses": [
      {
        "text": "Due to the high demand of applicants we are receiving, we will prioritize first *users who complete the discovery process* 😉",
        "order": 0,
        "entity": "text"
      }
    ],
